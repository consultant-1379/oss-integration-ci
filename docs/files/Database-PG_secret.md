# Postgres Database Secret Creation.

[TOC]

## Introduction

This file can be used to create the Postgres Database secret.
The Jenkins files covers the steps from the IDUN & EO Deployment document, section "Pre-Deployment (step 3 - Create a generic secret database-pg-secret for the Postgres admin user).
...
- Takes in the 14 input parameters discussed down below.

- The file using the inputted paramater creates the generic secret for database-pg-secret if not already created

### Repo Files
The following files within the oss-integration-ci [repo](https://gerrit-gamma.gic.ericsson.se/#/admin/projects/OSS/com.ericsson.oss.aeonic/oss-integration-ci)
are used in its execution.
- ci/jenkins/files/pre-deploy/database-pg-secret.Jenkinsfile *(Main Jenkins File)*
- ci/jenkins/rulesets/ruleset2.0.yaml
- ci/jenkins/scripts/create-database-pg-secret.sh

### Resources

The following is an example of the Jenkinsfile used in a job within the Base and Product staging flows
- [Jenkins Jobs](https://fem7s11-eiffel216.eiffel.gic.ericsson.se:8443/jenkins/job/OSS-Integration-predeploy-database-pg-secret/)
...
| SECRET_NAME              | Postgres secret name to be created                                                                                                                                                                                                                             | eric-eo-database-pg-secret                                               |
| CUSTOM_USER_ID           | Postgres Custom User Id                                                                                                                                                                                                                                        | customuser                                                               |
| CUSTOM_PASSWORD          | Postgres Custom Password                                                                                                                                                                                                                                       | Postgres123!                                                             |
| SUPER_USER_ID            | Postgres Super User Id                                                                                                                                                                                                                                         | postgres                                                                 |
| SUPER_PASSWORD           | Postgres Super User Password                                                                                                                                                                                                                                   | Postgres123!                                                             |
| METRICS_USER_ID          | Postgres Metric User Id                                                                                                                                                                                                                                        | exporter                                                                 |
| METRICS_PASSWORD         | Postgres Metric Password                                                                                                                                                                                                                                       | Postgres123!                                                             |
| REPLICA_USER_ID          | Postgres Replica User ID                                                                                                                                                                                                                                       | eric-oss-commmon-base                                                    |
| REPLICA_PASSWORD         | Postgres Replica PASSWORD                                                                                                                                                                                                                                      | Postgres123!                                                             |
...
- Within the "Pipeline Section" of the Jenkins Job Configuration set the following
    ...
    * **Script Path:** ci/jenkins/files/pre-deploy/database-pg-secret.Jenkinsfile
