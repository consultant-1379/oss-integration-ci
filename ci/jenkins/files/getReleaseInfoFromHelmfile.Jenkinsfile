    ...
    stages {
        ...
        stage('Get Release Information and save to files') {
            steps {
                ...
                archiveArtifacts 'releases_and_associated_csar.json'
                archiveArtifacts 'helmfile_json_content.json'
                archiveArtifacts 'csar_to_be_built.properties'
                archiveArtifacts 'csar_build.properties'
            }
        }
    }
    post {
