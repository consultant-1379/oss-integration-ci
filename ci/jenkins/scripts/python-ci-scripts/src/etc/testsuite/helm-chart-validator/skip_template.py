...
class SkipTemplate(metaclass=Singleton):
    ...
    def get_master_skips_file(self):
        ...
        with open(self.common_skip_list_path_json, encoding="utf-8") as common_skip_list:
            with open(self.skip_list_path_json, encoding="utf-8") as skip_list:
        ...
        with open(self.master_list_path_json, 'w', encoding="utf-8") as output_file:
            json.dump(skip_list_json_object, output_file, indent=4)

    def get_skips_from_name(self, name):
        """Get the list of test to skip."""
        tuple_list = []
        with open(self.master_list_path_json, encoding="utf-8") as json_file:
